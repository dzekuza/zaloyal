-- Simple Twitter Sync - One-time sync of existing Twitter data
-- This script syncs Twitter identity data from auth.identities to public.social_accounts

-- First, let's see what Twitter data we have
SELECT 
    'Twitter data in auth.identities:' as info,
    user_id,
    provider,
...
-- Now sync this data to social_accounts
