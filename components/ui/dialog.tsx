...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-2xl translate-x-[-50%] translate-y-[-50%] border border-[#282828] bg-[#111111] shadow-lg duration-200 sm:rounded-lg sm:zoom-in-90 max-h-[80vh] overflow-y-auto dialog-scrollbar font-body mx-4 sm:mx-0",
        className
      )}
      {...props}
    >
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left font-body px-6 pt-6 pb-4",
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 font-body px-6 pb-6",
      className
    )}
    {...props}
  />
