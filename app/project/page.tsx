    ...
    return (
      <PageContainer>
        <div className="space-y-4 sm:space-y-6">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">My Projects</h1>
          <Card className="bg-[#111111] border-[#282828] backdrop-blur-sm p-6 sm:p-8 max-w-md mx-auto">
            <div className="text-center">
              <Users className="w-12 h-12 sm:w-16 sm:h-16 mx-auto text-blue-400 mb-4" />
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">No Projects Found</h2>
              <p className="text-gray-300 mb-6 text-sm sm:text-base">You haven't registered any projects yet.</p>
